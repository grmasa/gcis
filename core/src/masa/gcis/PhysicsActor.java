...
public class PhysicsActor extends Actor{
    ...
    public String label;
    boolean active = true;
    private ActorAction<PhysicsActor, Greeceball> beginContactAction, endContactAction;
    ...
    public void reactToBeginContact(PhysicsActor me, Greeceball him){
        if(beginContactAction!=null) beginContactAction.commenceOperation(me, him);
    }

    public void reactToEndContact(PhysicsActor me, Greeceball him){
    ...
    private void prepareBody(World world, Vector2 position, String textureName, BodyDef.BodyType bodyType, String label){
        this.textureName = textureName;
        beginContactAction = new ActorAction<PhysicsActor, Greeceball>() {
            @Override
