...
import masa.gcis.FollowingCamera;
...
public class SkyActor extends Group {
    ...
    private Sprite bgSprite = new Sprite(Game.content.getTexture("acropolis"));
    ...
    public void updateTexture(){
        bgSprite.setTexture(Game.content.getTexture("acropolis"));
    }
